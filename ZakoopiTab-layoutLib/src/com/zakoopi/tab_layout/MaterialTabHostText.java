...
public class MaterialTabHostText extends RelativeLayout implements View.OnClickListener {
	...
	public MaterialTabHostText(Context context) {
		this(context, null);
	}
	
	public MaterialTabHostText(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}
	
	@SuppressLint("NewApi") public MaterialTabHostText(Context context, AttributeSet attrs, int defStyleAttr) {
