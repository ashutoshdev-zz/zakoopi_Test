package com.zakoopi.tab_layout;
...
public class MaterialTabHostIcon extends RelativeLayout implements View.OnClickListener {
	...
	public MaterialTabHostIcon(Context context) {
		this(context, null);
	}
	
	public MaterialTabHostIcon(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}
	
	@SuppressLint("NewApi") public MaterialTabHostIcon(Context context, AttributeSet attrs, int defStyleAttr) {
		...
		// get attributes
		if(attrs != null) {
			TypedArray a = context.getTheme().obtainStyledAttributes(attrs,R.styleable.MaterialTabHostText, 0, 0);
			
			try {
                // custom attributes
				hasIcons = a.getBoolean(R.styleable.MaterialTabHostText_hasIcons, false);
				
                primaryColor = a.getColor(R.styleable.MaterialTabHostText_materialTabsPrimaryColor, Color.parseColor("#26B3AD"));
				  // primaryColor = a.getColor(R.styleable.MaterialTabHostText_materialTabsPrimaryColor, Color.parseColor("#F9F9F9"));
                accentColor = a.getColor(R.styleable.MaterialTabHostText_accentColor,Color.parseColor("#26B3AD"));
				//accentColor = a.getColor(R.styleable.MaterialTabHostText_accentColor,Color.parseColor("#26B3AD"));
                iconColor = a.getColor(R.styleable.MaterialTabHostText_iconColor,Color.WHITE);
              //  textColor = a.getColor(R.styleable.MaterialTabHostText_textColor,Color.DKGRAY);
			} finally {
				a.recycle();
			}
		}
