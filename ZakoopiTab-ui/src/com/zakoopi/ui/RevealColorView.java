...
import com.zakoopi.ui.util.BakedBezierInterpolator;
import com.zakoopi.ui.util.UiHelper;
...
public class RevealColorView extends ViewGroup {
	...
	@SuppressLint("NewApi") public RevealColorView(Context context, AttributeSet attrs, int defStyleAttr) {
	...
	@SuppressLint("NewApi") public void reveal(final int x, final int y, final int color, final int startRadius, long duration, final Animator.AnimatorListener listener) {
		if (color == inkColor) {
			return;
		}
		inkColor = color;
	...
	@SuppressLint("NewApi") public void hide(final int x, final int y, final int color, final int endRadius, final long duration, final Animator.AnimatorListener listener) {
	...
	@SuppressLint("NewApi") private void prepareView(View view, int x, int y, float scale) {
