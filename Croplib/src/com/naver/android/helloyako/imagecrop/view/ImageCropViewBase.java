...
public abstract class ImageCropViewBase extends ImageView{
    ...
    public static final double DEFAULT_ASPECT_RATIO_HEIGHT = 1.5;
    ...
    private double mAspectRatioHeight = ImageCropViewBase.DEFAULT_ASPECT_RATIO_HEIGHT;

    private float mTargetAspectRatio = (float) (mAspectRatioHeight / mAspectRatioWidth);
	...
	public void setImageResource(int resId) {
	 ...
	 public void setAspectRatio(int aspectRatioWidth, double aspectRatioHeight){
